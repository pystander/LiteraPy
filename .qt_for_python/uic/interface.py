...
class Ui_litera_window(object):
    def setupUi(self, litera_window):
        ...
        self.adsearch_browser.setGeometry(QtCore.QRect(400, 90, 381, 451))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.search_browser.setGeometry(QtCore.QRect(10, 90, 381, 451))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        ...
        self.preview_label.setGeometry(QtCore.QRect(10, 50, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        self.preview_label.setFont(font)
        self.preview_label.setObjectName("preview_label")
        self.preview_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.preview_label_2.setGeometry(QtCore.QRect(400, 50, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        self.preview_label_2.setFont(font)
    ...
    def retranslateUi(self, litera_window):
        ...
        self.preview_label.setText(_translate("litera_window", "前綴搜尋"))
        self.preview_label_2.setText(_translate("litera_window", "完整搜尋"))
